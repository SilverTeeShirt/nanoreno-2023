...
define config.name = _("Space Breakers")
...
define build.name = "SpaceBreakers"
...
define config.main_menu_music = "audio/music/menumusic.ogg"
...
define config.save_directory = "SpaceBreakers-1677671599"
...
init python:
    ...
    build.classify('game/**.otf', 'scriptsarchive')  
