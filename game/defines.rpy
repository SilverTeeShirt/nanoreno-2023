...
define c = Character("Computer", color="#8888887f")
...
define rm2_powermail= ImageInteractable("rm2_powerconnector",1,352,775,0,[0],[0],"","rm2_powermaillook","inter/inter150x150_%s.png","inter/inter150x150_idle.png")

define marnie_rm2= ImageInteractable("Marnie",1,545,680,0,[0],[0],"","marnietalk","inter/talk/marnie1_%s.png","inter/talk/marnie1_idle.png")
define sprocko_rm2= ImageInteractable("Sprocko",1,228,735,0,[0],[0],"","sprockotalk","inter/talk/sprocko1_%s.png","inter/talk/sprocko1_idle.png")
define gelato_rm2= ImageInteractable("Gelato",1,1140,447,0,[0],[0],"","gelatotalk","inter/talk/gelato1_%s.png","inter/talk/gelato1_idle.png")
define otus_rm2= ImageInteractable("Captain Otus",1,1150,615,0,[0],[0],"","otustalk","inter/talk/otus1_%s.png","inter/talk/otus1_idle.png")
define ai_rm2= ImageInteractable("The Caretaker",3,1645,675,0,[0],[0],"","aitalk","inter/talk/ai1_%s.png","inter/talk/ai1_idle.png")
...
define sprocko_rm3= ImageInteractable("Sprocko",3,1120,475,0,[0],[0],"","sprockotalk","inter/talk/sprocko2_%s.png","inter/talk/sprocko2_idle.png")
...
define rm4_light= ImageInteractable("",1,415,407,0,[0],[0],"","rm4_lightlook","inter/inter_%s.png","inter/inter_idle.png")
define forest= ImageInteractable("",1,1410,490,0,[0],[0],"","forestlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define colorfulflower= ImageInteractable("",1,1520,50,0,[0],[0],"","colorfulflowerlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define bird= ImageInteractable("",1,525,705,0,[0],[0],"","birdlook","inter/inter150x150_%s.png","inter/inter150x150_idle.png")

define marnie_rm4= ImageInteractable("Marnie",3,1180,550,0,[0],[0],"","marnietalk","inter/talk/marnie2_%s.png","inter/talk/marnie2_idle.png")
...
###################rm_6 reactor core
define memento= ImageInteractable("",1,1685,540,0,[0],[0],"","mementolook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define rm6_door= ImageInteractable("",1,1525,30,0,[0],[0],"","rm6_doorlook","inter/inter150x650_%s.png","inter/inter150x650_idle.png")
define jarbot= ImageInteractable("",1,0,670,0,[0],[0],"","jarlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define jartop= ImageInteractable("",1,-35,100,0,[0],[0],"","jarlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define jarman= ImageInteractable("",1,-25,360,0,[0],[0],"","jarmanlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define rm6_computer= ImageInteractable("",1,300,450,0,[0],[0],"","rm6_computerlook","inter/inter300x300_%s.png","inter/inter300x300_idle.png")
define deadguy= ImageInteractable("",1,900,750,0,[0],[0],"","deadguylook","inter/inter300x150_%s.png","inter/inter300x150_idle.png")
...
define rm0_lockerkey = Item("Boot Key",0,"item/item_key1_%s.png","Too small key found in a boot. It has a with a diamond symbol in it.", [],[],"item/item_key1_idle.png",["rm0_lockerkeycommsp","rm0_lockerkeycommmar","rm0_lockerkeycommot","rm0_lockerkeycomgel","rm0_lockerkeycomai"])

define rm0_food = Item("Food Bar",1,"item/item_food1_%s.png", "A nasty looking food bar. You could swear it's squirming in your hand.",[], [], "item/item_food1_idle.png",["rm0_foodcommsp","rm0_foodcommmar","rm0_foodcommot","rm0_foodcomgel","rm0_foodcomai"] )

define item_powerfittings = Item("Expandable Power Fittings",0,"item/item_fittings_%s.png", "A large extendable power fitting. It can stretch great distances and carry a high density of energy.",[], ["item_fittingssolution"], "item/item_fittings_%s.png",["item_NAsp","item_NAmar","item_NAot","item_NAgel","item_NAai"] )

define item_keyset = Item("Key Set",0,"item/item_keyset_%s.png", "A set of locker kets with a symbols on them.",[], ["item_fittingssolution"], "item/item_keyset_%s.png",["item_NAsp","item_NAmar","item_NAot","item_NAgel","item_NAai"] )
