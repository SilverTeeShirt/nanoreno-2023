...
define rm0_shoe= ImageInteractable("",1,1300,705,0,[0],[0],"","shoe1look",["inter/inter150x150_%s.png"],"inter150x150_idle.png")
...
#define room2 = Room("2nd room",1,"bg_ship2",[interactable1,interactable2],0,0,[0],"bg_ship2")




## Roommanager (and Inventory soon)
define roommanager = RoomManager("roommanager",[RM0_coldsleeproom],RM0_coldsleeproom,1,1,1)
